...
CREATE TABLE `admin_activity_logs` (
  ...
  `target_type` enum('user','product','order','category','setting','backup') COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `admin_alerts` (
  ...
  `login_identifier` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `admin_dashboard_stats` (
  ...
  `stat_type` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `bardproductsredeem` (
  ...
  `user_type` enum('buyer','seller') COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `ecocoins_transactions` (
  ...
  `transaction_type` enum('earn','spend','transfer','adjustment') COLLATE utf8mb4_general_ci NOT NULL,
  `description` text COLLATE utf8mb4_general_ci,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE `messages` (
  ...
  `sender_type` enum('buyer','admin') COLLATE utf8mb4_general_ci NOT NULL,
  `message_text` text COLLATE utf8mb4_general_ci NOT NULL,
  `feedback_text` text COLLATE utf8mb4_general_ci,
  `status` enum('sent','received','replied','archived') COLLATE utf8mb4_general_ci DEFAULT 'sent',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE `order_items` (
  ...
  `proof_photo` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `products` (
  ...
  `seller_id` int NOT NULL,
  `category_id` int NOT NULL,
  `producers` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `sellers` (
  ...
  `last_login` datetime DEFAULT NULL,
  `ecocoins_balance` decimal(10,2) NOT NULL DEFAULT '0.00',
  `gcash_qr` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `transaction_logs` (
  ...
  `user_id` int NOT NULL,
  `user_type` enum('buyer','seller','admin') COLLATE utf8mb4_general_ci NOT NULL,
  `action` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  `description` text COLLATE utf8mb4_general_ci,
  `ip_address` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `user_agent` text COLLATE utf8mb4_general_ci,
...
-- Dump completed on 2026-02-06 20:36:54
